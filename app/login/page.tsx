...
const translations: Record<Lang, Translation> = {
  RO: {
    ...
    freeCalculation: "Configurezi gratuit. Rezultatul complet se deblochează cu credit sau abonament",
  ...
  EN: {
    ...
    freeCalculation: "Configure for free. Unlock the full result with a credit or subscription",
    email: "Email address",
