...
const content = {
  ro: {
    ...
    free: "Calculatorul brut-net simplu este gratuit. Rezultatul lunar complet se deblochează cu credit sau abonament.",
  ...
  en: {
    ...
    free: "The basic gross-net calculator is free. Unlock the complete monthly result with a credit or subscription.",
