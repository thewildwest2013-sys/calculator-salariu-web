...
const content = {
  ro: {
    ...
    free: "Calculatorul brut-net simplu este gratuit. Pentru fiecare calcul salarial complet folosești 1 credit sau un abonament.",
  ...
  en: {
    ...
    free: "The basic gross-net calculator is free. Each complete payroll calculation uses 1 credit or an active subscription.",
